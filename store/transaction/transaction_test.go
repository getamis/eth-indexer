...
var _ = Describe("Transaction Database Test", func() {
	...
	It("should insert", func() {
		...
		data1 := makeTx("0x58bb59babd8fd8299b22acb997832a75d7b6b666579f80cc281764342f2b373b", blockHex)
		...
		data2 := makeTx("0x68bb59babd8fd8299b22acb997832a75d7b6b666579f80cc281764342f2b373b", blockHex)
	...
	It("should get transaction by hash", func() {
		...
		data1 := makeTx("0x58bb59babd8fd8299b22acb997832a75d7b6b666579f80cc281764342f2b373b", blockHex1)
		data2 := makeTx("0x68bb59babd8fd8299b22acb997832a75d7b6b666579f80cc281764342f2b373b", blockHex1)
		data3 := makeTx("0x78bb59babd8fd8299b22acb997832a75d7b6b666579f80cc281764342f2b373b", blockHex2)
